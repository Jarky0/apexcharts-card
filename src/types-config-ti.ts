...
export const ChartCardExternalConfig = t.iface([], {
  ...
  "edit_mode": t.opt("boolean"),
  "use_duration_format": t.opt("boolean"),
});
...
export const ChartCardBrushExtConfig = t.iface([], {
  ...
  "height": t.opt(t.union("number", "string")),
  "apex_config": t.opt("any"),
});
...
export const ChartCardAllSeriesExternalConfig = t.iface([], {
  ...
  "name": t.opt("string"),
  "type": t.opt(t.union(t.lit('line'), t.lit('column'), t.lit('area'), t.lit('scatter'), t.lit('pie'), t.lit('donut'), t.lit('radialBar'))),
...
export const ChartCardSeriesShowConfigExt = t.iface([], {
  ...
  "extremas_config": t.opt(t.iface([], {
    "marker_size": t.opt("number"),
    "marker_color": t.opt("string"),
    "marker_stroke_color": t.opt("string"),
    "marker_stroke_width": t.opt("number"),
    "marker_shape": t.opt("string"),
    "label_border_color": t.opt("string"),
    "label_border_width": t.opt("number"),
    "label_border_radius": t.opt("number"),
    "label_text_anchor": t.opt("string"),
    "label_orientation": t.opt("string"),
    "label_offset_x": t.opt("number"),
    "label_offset_y": t.opt("number"),
    "label_background": t.opt("string"),
    "label_color": t.opt("string"),
    "label_font_size": t.opt("string"),
    "label_font_weight": t.opt("number"),
    "label_font_family": t.opt("string"),
    "label_padding_left": t.opt("number"),
    "label_padding_right": t.opt("number"),
    "label_padding_top": t.opt("number"),
    "label_padding_bottom": t.opt("number"),
    "label_text": t.opt(t.iface([], {
      "min": t.opt("string"),
      "max": t.opt("string"),
    })),
  })),
...
export const ChartCardSeriesExternalConfig = t.iface(["ChartCardAllSeriesExternalConfig"], {
  "entity": "string",
  "header_config": t.opt(t.iface([], {
    "show_state": t.opt("boolean"),
    "show_uom": t.opt("boolean"),
    "show_name": t.opt("boolean"),
  })),
  "period": t.opt("StatisticsPeriod"),
});
